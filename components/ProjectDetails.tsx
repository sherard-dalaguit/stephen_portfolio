...
export const ProjectItems = ({
  ...
  return (
    <div className="relative mt-10 px-4 sm:px-6 lg:px-12 py-8 grid items-center gap-8 rounded-xl border border-blue-50/20 bg-gradient-to-b from-[#d1b3ff]/20 to-slate-50/5 lg:grid-cols-3 lg:gap-0">
      <div className={
				clsx(
